...
class OmxPlayer extends EventEmitter {
  ...
  getListSubtitles(cb){
    return this._invokeDBus('ListSubtitles', DBUS_INTERFACE_PROPERTIES, null, null, cb);
  }
  getListAutio(cb){
    return this._invokeDBus('ListAudio', DBUS_INTERFACE_PROPERTIES, null, null, cb);
  }
  getListVideo(cb){
    return this._invokeDBus('ListVideo', DBUS_INTERFACE_PROPERTIES, null, null, cb);
  }
  selectSubtitles(index, cb){
    return this._invokeDBus('SelectSubtitle', DBUS_INTERFACE_PROPERTIES, 'i', [index], cb);
  }
  selectAudio(index, cb){
    return this._invokeDBus('SelectAudio', DBUS_INTERFACE_PROPERTIES, 'i', [index], cb);
  }
